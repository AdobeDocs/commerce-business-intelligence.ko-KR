...
`Cohort Report Builder`은(는) 일반 `cohort date`을(를) 기준으로 사용자를 그룹화하는 데 최적화되어 있습니다. 유사한 활동이나 속성으로 사용자를 그룹화하는 데 관심이 있을 수 있습니다. 시작하려면 질적 집단에 대한 [이 튜토리얼](../dev-reports/create-qual-cohort-analysis.md)을(를) 확인하는 것이 좋습니다.
