...
*그럴 경우 이 테이블에 모든 고객이 포함되지 않을 수 있습니다. 고객 분석에 모든 고객이 포함되는지 확인하려면 [지원 팀](https://experienceleague.adobe.com/ko/docs/commerce-knowledge-base/kb/troubleshooting/miscellaneous/mbi-service-policies)에 문의하십시오.*
