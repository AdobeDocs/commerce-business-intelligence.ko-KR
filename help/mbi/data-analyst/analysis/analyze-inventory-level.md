---
title: 재고 레벨 분석
description: 대시보드를 작성하여 Commerce Intelligence의 현재 재고 수준을 모니터링합니다. 지침은 기존 및 새 아키텍처 계정 구성을 모두 다룹니다.
