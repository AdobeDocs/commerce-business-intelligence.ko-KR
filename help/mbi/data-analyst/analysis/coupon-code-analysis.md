---
title: 쿠폰 성능
description: Commerce Intelligence에서 쿠폰 성능을 분석합니다. 쿠폰 코드별로 주문을 세그먼트화하여 획득을 유도하고, 사용량을 추적하고, 결과를 측정할 수 있는 쿠폰을 확인합니다.
...
![주요 지표를 표시하는 분석 라이브러리의 쿠폰 코드 분석](../../assets/coupon_analysis_-_analysis_library.png)<!--{: width="800" height="375"}-->
