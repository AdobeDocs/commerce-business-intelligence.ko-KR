...
description: 보고서에서 예상할 내용을 알 수 있도록 Analytics 2.0 보고 API를 사용하여 Commerce Intelligence이 Adobe Analytics에서 가져오는 데이터 필드를 검토하십시오.
