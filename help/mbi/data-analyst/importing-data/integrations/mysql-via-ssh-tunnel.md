...
description: SSH 터널을 사용하여 MySQL 데이터베이스를 Commerce Intelligence에 안전하게 연결합니다. 공개 키 검색, IP 주소 허용 목록 및 사용자 구성.
...
* [`direct connection`을(를) 통한 [!DNL MySQL]](../integrations/mysql-via-a-direct-connection.md)
