...
더 많은 예를 보려면 저장소에서 닫힌 끌어오기 요청을 검색하여 기존 하이라이트의 서식을 확인하고 [새로운 기능 섹션](https://experienceleague.adobe.com/en/docs/commerce-operations/operational-guides/home#whats-new)과 비교하여 설명서에 어떻게 표시되는지 확인하십시오.
